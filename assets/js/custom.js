   ...
   var total_stock = $("#total_stock").val();
    $('#checkListStockList').DataTable({ 
           ...
           'lengthMenu':[[10, 25, 50,100,250,500, total_stock], [10, 25, 50,100,250,500, "All"]],
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': base_url + 'report/report/kpntwks_checkStocklist',
                data:{
   ...
   var base_url  = $('#base_url').val();
    var mydatatable = $('#CustomerList').DataTable({ 
           ...
           'lengthMenu':[[10, 25, 50,100,250,500, -1], [10, 25, 50,100,250,500, "All"]],
            ...
            'serverMethod': 'post',
            'ajax': {
               'url':base_url + 'customer/customer/kpntwks_CheckCustomerList',
            "data": function ( data) {
...
$(document).ready(function() { 
   ...
   var CSRF_TOKEN = $('#CSRF_TOKEN').val();
   var base_url  = $('#base_url').val();
    var mydatatable = $('#CustomerGroupList').DataTable({ 
             responsive: true,
           ...
           'serverSide': true,
            ...
            'serverMethod': 'post',
            'ajax': {
               'url':base_url + 'customer/customer/kpntwks_CheckCustomerGroupList',
               "data": function ( data) {
         data.csrf_test_name = CSRF_TOKEN;
         data.customfiled =  $("select[name='customsearch[]']").val();
},    
...
function customerdelete(id) {
    ...
    if (r == true) {
        $.ajax({
            url: base_url + "customer/customer/kpntwks_delete/"+id,
            type: "GET",
            success: function (r) {
               toastr["success"](r);
                setTimeout(function () {
...
function customergroupdelete(id) {
    ...
    if (r == true) {
        $.ajax({
            url: base_url + "customer/customer/kpntwks_group_delete/"+id,
            type: "GET",
            success: function (r) {
               toastr["success"](r);
                setTimeout(function () {
   ...
   var base_url  = $('#base_url').val();
    var mydatatable = $('#Credit_customerList').DataTable({ 
           ...
           'lengthMenu':[[10, 25, 50,100,250,500, -1], [10, 25, 50,100,250,500, "All"]],
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': base_url + 'customer/customer/kpntwks_CheckCreditCustomerList',
            "data": function ( data) {
         data.csrf_test_name = CSRF_TOKEN;
         data.customer_id =  $('#customer_id').val();
         data.customfiled =  $("select[name='customsearch[]']").val();
   ...
   var customer_id = $('#customer_id').val();
    ...
    var mydatatable = $('#paid_CustomerList').DataTable({ 
           ...
           'lengthMenu':[[10, 25, 50,100,250,500, -1], [10, 25, 50,100,250,500, "All"]],
            ...
            'serverMethod': 'post',
            'ajax': {
               'url':base_url + 'customer/customer/kpntwks_CheckPaidCustomerList',
            "data": function ( data) {
         data.csrf_test_name = CSRF_TOKEN;
         data.customer_id =  $('#customer_id').val();
         data.customfiled =  $("select[name='customsearch[]']").val();
   ...
   var base_url     = $("#base_url").val();
    var mydatatable = $('#supplierList').DataTable({ 
           ...
           'lengthMenu':[[10, 25, 50,100,250,500, -1], [10, 25, 50,100,250,500, "All"]],
            ...
            'serverMethod': 'post',
            'ajax': {
               'url': base_url + 'supplier/supplier/kpntwks_ChecksupplierList',
            "data": function ( data) {
         data.csrf_test_name = CSRF_TOKEN;
...
function supplierdelete(id) {
    ...
    if (r == true) {
        $.ajax({
            url: base_url + "supplier/supplier/kpntwks_delete/"+id,
            type: "GET",
            success: function (r) {
               toastr["success"](r);
                setTimeout(function () {

...
class Tax extends MX_Controller {
    ...
    // ============== Tax settings ================
    public function kpntwks_tax_settings(){
       ...
       public function kpntwks_vat_tax_settings(){
    ...
    public function update_tax_settins(){
      ...
      public function kpntwks_income_tax(){
       ...
       // ================ Income tax entry   ======
    public function kpntwks_create_income_tax(){

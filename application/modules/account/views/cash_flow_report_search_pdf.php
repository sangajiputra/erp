                ...
                <div class="panel-body">
                    <div>
                        ...
                        <table width="100%" class="table_boxnew" style="padding: 5px">
                            ...
                            <tr class="table_head">
                                ...
                                <td width="30%" align="right"
                                    ...
                                    <b><?php echo display('amount_in_Dollar');?></b></td>
                            </tr>
                            <tr class="table_head">
                                <td colspan="3" style="padding-left:10px">
                                    <strong><?php echo display('opening_cash_and_equivalent');?>:</strong></td>
                            </tr>
                            <?php
                        ...
                        ?>
                            ...
                            <tr class="table_head">
                                <td colspan="3" style="padding-left:10px;text-decoration:underline"><b>Cashflow from

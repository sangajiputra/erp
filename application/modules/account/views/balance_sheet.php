<link href="<?php echo base_url('application/modules/account/assets/css/accounts_style.css'); ?>" rel="stylesheet"
    type="text/css" />
<div class="row">
    <div class="col-sm-12">
            ...
            ?>
                <div class="form-group">
                    ...
                    <input type="text" name="dtpFromDate" class="form-control datepicker" id="from_date"
                        placeholder="<?php echo display('start_date') ?>" value="<?php echo $from_date ?>">
                </div>

                <div class="form-group">
                    <label class="" for="to_date"><?php echo display('end_date') ?></label>
                    <input type="text" name="dtpToDate" class="form-control datepicker" id="to_date"
                        placeholder="<?php echo display('end_date') ?>" value="<?php echo $to_date ?>">
                </div>
                    ...
                    <table width="100%" class="table_boxnew table-bordered" cellpadding="0" cellspacing="0">
                        <tr class="table_head">
                            <td width="73%" height="29" align="center" class="cashflowparticular">
                                <b><?php echo display('particulars');?></b></td>
                        ...
                        <tr>
                            <td align="left"
                                class="paddingleft10px <?php if($assets['HeadName'] =='Current Assets' || $assets['HeadName'] =='Non-current assets'){echo 'balancesheet_head';}?>">
                        ...
                        <?php if($cchead['HeadName'] == 'Cash in Banks' || $cchead['HeadName'] == 'Account Receivable' || $cchead['HeadName'] == 'Customers' || $cchead['HeadName'] == 'Loan Receivable'){
                        ...
                        <tr>
                            <td class="text-right"> <b><?php echo display('total')?>
                                    <?php echo $assets['HeadName']; ?></b>&nbsp;&nbsp;</td>
                        ...
                        <tr>
                            <td align="left"
                                class="paddingleft10px <?php if($liability['HeadName'] =='Current Liabilities' || $liability['HeadName'] =='Current Liabilities'){echo 'balancesheet_head';}?>">
                        ...
                        <tr>
                            <td class="paddingleft10px text-right"><b><?php echo display('total')?>
                                    <?php echo $liability['HeadName']; ?></b>&nbsp;&nbsp;</td>
                        ...
                        <tr>
                            <td align="left" class="paddingleft10px balancesheet_head">
                                <?php echo $incomelable['HeadName']; ?></td>

     ...
     <div class="col-sm-12">
         <div class="panel panel-bd lobidrag">
             ...
             <div class="panel-body">
                 ...
                 <div class="form-group row">
                     <label for="customer_name"
                         class="col-sm-2 text-right col-form-label">Group Category<i
                             class="text-danger"> * </i>:</label>
                     <div class="col-sm-4">
                         <div class="">
                            <select class="form-control" name="group_category" id="group_category">
                                ...
                                <?php foreach ($group as $a) { ?>
                                    <option value="<?= $a->id_group ?>" <?php if($customer->group_id ==$a->id_group){echo 'selected';}?>><?= $a->group_name ?></option>
                                <?php } ?>
                            </select>

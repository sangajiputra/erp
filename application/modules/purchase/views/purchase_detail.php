                    ...
                    <table class="table table-striped print-font-size">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th width="20%" class="text-center">SN</th>
                                <th width="20%" class="text-center">QR</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo $details['purchase_detail_id']?></td>
                                <td class="text-center"><a href="<?= $base_url.'qrcode/'.$details['purchase_detail_id'] ?>" class="btn btn-success btn-xs" data-toggle="tooltip" data-placement="left" title="<?= display('qr_code') ?>"><i class="fa fa-qrcode" aria-hidden="true"></i></a>
                                    <!-- <img src="http://chart.apis.google.com/chart?cht=qr&chs=100x100&chld=L|4&chl=<?php echo $qr?>" alt=""> -->
                                </td>

...
class Service extends MX_Controller {
 ...
 public function kpntwks_service_form(){
    ...
    public function kpntwks_manage_service(){
    ...
    public function kpntwks_edit_service($service_id) {
    ...
    function uploadCsv_service()
     ...
     $acc_service = [
        ...
        public function kpntwks_service_invoice_form() {
        $data = array(

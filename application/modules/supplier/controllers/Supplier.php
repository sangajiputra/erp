...
class Supplier extends MX_Controller {
    ...
    public function kpntwks_ChecksupplierList(){
  ...
  public function kpntwks_form($id = null)
    ...
    public function kpntwks_supplier_ledger() {
   $data['title']    = display('supplier_ledger'); 
    ...
    public function kpntwks_supplier_ledgerData() {
    ...
    public function kpntwks_supplier_advance() {
  ...
  //supplier_advance_receipt
   public function supplier_advancercpt($receiptid=null,$supplier_id=null) {
    ...
    echo Modules::run('template/layout', $data); 
        ...
        public function kpntwks_supplier_ledgerinfo($supplier_id) {
        $supplier_details = $this->supplier_model->supplier_personal_data($supplier_id);

...
class Product extends MX_Controller {
   ...
   // category part
    function kpntwks_category_list() {
      ...
      public function kpntwks_category_form($id = null)
    {
    ...
    public function kpntwks_deletecategory($id = null) {
    ...
    // unit part
      ...
      public function kpntwks_unit_form($id = null)
    {
    ...
    public function kpntwks_deleteunit($id = null) {
    ...
    public function kpntwks_product_list(){
    ...
    public function CheckProductList(){
        ...
        public function kpntwks_deleteproduct($id = null) {
    ...
    public function kpntwks_csv_product(){
    ...
    function uploadCsv()
    {
        ...
        $product_info = $this->product_model->kpntwks_barcode_productdata($product_id);
        $data = array(
...
public function kpntwks_product_details($product_id = null){
        $details_info = $this->product_model->kpntwks_barcode_productdata($product_id);

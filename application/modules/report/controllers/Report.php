...
class Report extends MX_Controller {
 ...
 /*product stock part*/
    function kpntwks_stock_report() {
       ...
       public function kpntwks_checkStocklist(){
        // GET data
        $postData = $this->input->post();
        $data = $this->report_model->kpntwks_getStock($postData);
        echo json_encode($data);
    } 


        public function kpntwks_cash_closing() {
    ...
    public function kpntwks_closing_report(){
    ...
    public function kpntwks_closing_report_search(){
     ...
     public function kpntwks_todays_report(){
    ...
    public function kpntwks_todays_customer_received() {
        $today = date('Y-m-d');
    ...
    //    ============ its for todays_customer_receipt =============
       public function kpntwks_customerwise_received() {
        ...
        public function kpntwks_todays_sales_report(){
        $sales_report = $this->report_model->todays_sales_report();
        $sales_amount = 0;
        if (!empty($sales_report)) {
            $i = 0;
        ...
        public function kpntwks_datewise_sales_report(){
          $from_date = $this->input->get('from_date');
           $to_date  = $this->input->get('to_date');
        ...
        public function kpntwks_userwise_sales_report(){
        ...
        public function kpntwks_invoice_wise_due_report(){
     ...
     public function kpntwks_shippingcost_report(){
        $from_date =(!empty($this->input->get('from_date'))?$this->input->get('from_date'):date('Y-m-d')) ;
        $to_date = (!empty($this->input->get('to_date'))?$this->input->get('to_date'):date('Y-m-d'));
     ...
     public function kpntwks_purchase_report(){
         $from_date =(!empty($this->input->get('from_date'))?$this->input->get('from_date'):date('Y-m-d')) ;
        $to_date = (!empty($this->input->get('to_date'))?$this->input->get('to_date'):date('Y-m-d'));
       $purchase_report = $this->report_model->kpntwks_purchase_report($from_date, $to_date);
        $purchase_amount = 0;
     ...
     public function kpntwks_purchase_report_category_wise(){
        $from_date =(!empty($this->input->get('from_date'))?$this->input->get('from_date'):date('Y-m-d')) ;
        $to_date   = (!empty($this->input->get('to_date'))?$this->input->get('to_date'):date('Y-m-d'));
     ...
     public function kpntwks_sale_report_productwise(){
        $from_date =(!empty($this->input->get('from_date'))?$this->input->get('from_date'):date('Y-m-d')) ;
        $to_date = (!empty($this->input->get('to_date'))?$this->input->get('to_date'):date('Y-m-d'));
     ...
     public function kpntwks_categorywise_sales_report(){
         $from_date =(!empty($this->input->get('from_date'))?$this->input->get('from_date'):date('Y-m-d')) ;
        $to_date = (!empty($this->input->get('to_date'))?$this->input->get('to_date'):date('Y-m-d'));
        $category = (!empty($this->input->get('category'))?$this->input->get('category'):'');
        $category_list = $this->report_model->category_list_product();
     ...
     public function kpntwks_sales_return(){
        $from_date = $this->input->post('from_date',TRUE);
     ...
     public function kpntwks_supplier_return(){
        $from_date = $this->input->post('from_date',TRUE);
        $to_date   = $this->input->post('to_date',TRUE);
        $start     = (!empty($from_date)?$from_date:date('Y-m-d'));
        $end       = (!empty($to_date)?$to_date:date('Y-m-d'));
     ...
     public function kpntwks_tax_report(){
        $from_date =(!empty($this->input->get('from_date'))?$this->input->get('from_date'):date('Y-m-d')) ;
        $to_date = (!empty($this->input->get('to_date'))?$this->input->get('to_date'):date('Y-m-d'));
     ...
     public function kpntwks_profit_report(){
       ...
       public function kpntwks_add_closing(){

    ...
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <div class="panel-body">
                <?php echo form_open_multipart('invoice/invoice/kpntwks_manual_sales_insert',array('class' => 'form-vertical', 'id' => 'insert_sale','name' => 'insert_sale'))?>
                <div class="row">
                    ...
                    <table class="table table-bordered table-hover" id="normalinvoice">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="product_quantity[]" required=""
                                        onkeyup="kpntwks_invoice_quantity_calculate(1);"
                                        onchange="kpntwks_invoice_quantity_calculate(1);"
                                ...
                                <td class="invoice_fields">
                                    <input type="text" name="product_rate[]" id="price_item_1"
                                        ...
                                        onkeyup="kpntwks_invoice_quantity_calculate(1);"
                                        onchange="kpntwks_invoice_quantity_calculate(1);" placeholder="0.00" min="0" />
                                </td>
                                <!-- Discount -->
                                <td>
                                    <input type="text" name="discount[]" onkeyup="kpntwks_invoice_quantity_calculate(1);"
                                        onchange="kpntwks_invoice_quantity_calculate(1);" id="discount_1"
                                ...
                                <td>
                                    <input type="text" name="vatpercent[]"
                                        onkeyup="kpntwks_invoice_quantity_calculate(1);"
                                        onchange="kpntwks_invoice_quantity_calculate(1);" id="vat_percent_1"
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" onkeyup="kpntwks_invoice_quantity_calculate(1);"
                                        onchange="kpntwks_invoice_quantity_calculate(1);" id="invoice_discount"
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    <input type="text" id="shipping_cost" class="form-control text-right"
                                        name="shipping_cost" onkeyup="kpntwks_invoice_quantity_calculate(1);"
                                        onchange="kpntwks_invoice_quantity_calculate(1);" placeholder="0.00"
                                        tabindex="14" />
                                </td>
                            </tr>
                            <tr>

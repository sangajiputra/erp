...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-bd lobidrag">
            ...
            <?php echo form_open('invoice/invoice/kpntwks_update_invoice', array('class' => 'form-vertical', 'id' => 'update_invoice')) ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="product_quantity[]"
                                        onkeyup="kpntwks_invoice_quantity_calculate(<?php echo $details['sl']?>);"
                                        onchange="kpntwks_invoice_quantity_calculate(<?php echo $details['sl']?>);"

      ...
      <?php if($this->permission1->method('manage_designation','delete')->access()){ ?>                                
                                        <a href="<?php echo base_url('hrm/hrm/kpntwks_deletedesignation/'.$designations["id"]) ?>" class="btn btn-danger btn-sm"  onclick="return confirm('<?php echo display('are_you_sure') ?>')" data-toggle="tooltip" data-placement="right" title="" data-original-title="<?php echo display('delete') ?> "><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                    <?php }?>

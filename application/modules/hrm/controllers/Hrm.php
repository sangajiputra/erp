...
class Hrm extends MX_Controller {
    ...
    public function kpntwks_designation_list(){
        ...
        public function kpntwks_designation_form($id = null)
    {
       ...
       public function kpntwks_deletedesignation($id = null) {
     ...
     /*employee part start*/
      public function kpntwks_employee_form($id = null){
   ...
   $data['employee'] = (object)$postData = [
        ...
        public function kpntwks_employee_list(){
        ...
        public function kpntwks_employee_profile($id){
       ...
       public function kpntwks_delete_employee($id = null) {

...
class Attendance extends MX_Controller {
    ...
    public function kpntwks_add_attendance(){
      ...
      public function kpntwks_create_atten(){
...
public function sign_out(){
   ...
   if($this->attendance_model->signout($postData)){
    ...
    public function kpntwks_edit_attendance($id = null){
    ...
    function attendance_bulkupload()
    {
       ...
       public function kpntwks_delete_attendance($id = null) {
       ...
       // attendance report
    public function kpntwks_attendance_report() {
   ...
   public function kpntwks_datewiseattendancereport() {
    $data['title']      = display('attendance_report');

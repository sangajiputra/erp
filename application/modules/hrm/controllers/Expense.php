...
class Expense extends MX_Controller {
    ...
    public function kpntwks_expense_item_list(){
        ...
        public function kpntwks_expense_item_form($id = null)
    {
    ...
    public function kpntwks_add_expense(){
    ...
    echo Modules::run('template/layout', $data);
        ...
        public function kpntwks_create_expense(){

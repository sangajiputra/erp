...
class Permission extends MX_Controller
{
    ...
    public function kpntwks_user_roleassign(){
    ...
    public function kpntwks_add_role(){
    ...
    public function kpntwks_role_list(){
    ...
    public function kpntwks_edit_role($id){
    ...
    public function kpntwks_role_delete($id){
